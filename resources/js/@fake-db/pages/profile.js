...
const data = {
  ...
  teams: [
    ...
    },
    {
      ...
      description: 'The development of Vue and its ecosystem is guided by Vue team, some of whom have chosen to be featured below.',
      chips: [
        {
          title: 'Vuejs',
          color: 'success',
    ...
    },
    {
      ...
      description: 'Explore, install, use, and remix thousands of plugins and files published by designers and developers.',
      chips: [
        {
          title: 'UI/UX',
          color: 'success',
